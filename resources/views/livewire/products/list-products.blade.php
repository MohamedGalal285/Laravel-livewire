                        ...
                        <table id="example2" class="table table-bordered table-hover dataTable dtr-inline"
                            ...
                            <tbody>
                                ...
                                <tr class="odd">
                                    ...
                                    <td>
                                        <img src="{{asset($product->image)}}" style="width: 75px;object-fit: contain" alt="User profile">
                                    </td>
                                    <td>
                                        <button type="button" wire:click="edit({{ $product->id }})" class="btn btn-info btn-sm mr-2">Edit</button>
                                        <button type="button" wire:click="deleteId({{ $product->id }})" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#deleteModal">
                                            Delete</button>
