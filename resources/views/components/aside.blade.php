<aside
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href=""
            ...
            <span class="ms-1 font-weight-bold">Galal Dashboard</span>
        </a>
    </div>
        ...
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link active" href="">
                    <div
                        ...
                        <i class="ni ni-fa-users text-primary text-sm opacity-10"></i>
                    </div>
            ...
            <li class="nav-item">
                <a class="nav-link " href="./pages/virtual-reality.html">
                    ...
                    <span class="nav-link-text ms-1">All Sub Categories</span>
                </a>
            </li>
            <li class="nav-item mt-3">
