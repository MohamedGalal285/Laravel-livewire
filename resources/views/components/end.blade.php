<!--   Core JS Files   -->
    ...
    <script src="{{ URL::asset('assets/js/argon-dashboard.min.js?v=2.0.4') }}"></script>
    <script>
        ...
        window.addEventListener('show-notify-modal', function(e) {
            console.log(e.detail);
            $("#" + e.detail).modal('show');
            setTimeout(function(){
                $("#" + e.detail).modal('hide');
...
<script>
    document.addEventListener('livewire:load', function () {
        Livewire.on('itemCreated', function () {
            $('#created-alert').modal('show');
            setTimeout(function () {
                $('#created-alert').modal('hide');
            }, 2000);
        });
    });
</script>
